...
```
$ git clone -b ブランチ名（develop-****） https://github.com/yanbal-expert-php/Yanbaru-Qiita-App.git
```
...
$ ls
README.md               docker                  procedure_Mk-2.pdf      環境構築手順.md
development-document    docker-compose.yml      src
```
...
Mk-2設定参考：[procedure_Mk-2.pdf](https://github.com/shimotaroo/Yanbaru-Qiita-App/blob/main/procedure_Mk-2.pdf)
...
- [【前編】絶対に失敗しないDockerでLaravel + Vue.jsの開発環境（LEMP環境）を構築する方法〜MacOS Intel Chip対応〜](https://yutaro-blog.net/2021/04/29/docker-laravel-vuejs-intel-2/)
- [【後編】絶対に失敗しないDockerでLaravel + Vue.jsの開発環境（LEMP環境）を構築する方法〜MacOS Intel Chip対応〜](https://yutaro-blog.net/2021/04/30/docker-laravel-vuejs-intel-3/)
...
- [README.md](https://github.com/shimotaroo/Yanbaru-Qiita-App)に戻って、共同開発の概要を確認ください。